...
pubDatetime: 2016-12-06T00:00:00Z
description: "K-Means is a classic machine learning algorithm for discovering clusters within data sets"
tags:
  - ai
  - tutorial
---
...
![init-data](/images/ml/kmeans/k-means-initial.png)
...
![rand-init](/images/ml/kmeans/k-means-st0.png)

After the first iteration

![first-iter](/images/ml/kmeans/k-means-st1.png)

And after the second iteration, the cluster centers will settle, or converge
on their correct positions.

![last-iter](/images/ml/kmeans/k-means-st2.png)
...
[lg]: /posts/an-introduction-to-machine-learning
