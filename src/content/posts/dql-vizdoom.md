...
pubDatetime: 2018-10-09T00:00:00Z
description: "A deep Q-learning tutorial using PyTorch to train an agent to play Doom using the ViZDoom environment."
---
...
src="/images/rl-intro/episode-9.gif" alt="The trained RL agent
...
<img style="" src="/images/rl-intro/rl-loop.png" alt="The RL
loop">
</div>
...
<figure class="image">
<div style="display:block; margin:0 auto; text-align:center"> <img style=""
src="/images/rl-intro/episode-0.gif" alt="The trained RL agent
shooting a monster"> </div> <figcaption style="display:block;margin:0
...
[cifar]: /posts/wide-resnet-pytorch
